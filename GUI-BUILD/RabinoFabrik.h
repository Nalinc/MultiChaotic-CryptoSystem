...
#define BEGINrf 0                              //where to begin the computation
#define ENDrf   50                             //where to end
#define DTrf    0.001                          //stepsize in time
#define Nrf     3                              //number of equations
#define alpha     1.1						     //constant 'a' in Rabinovich-Fabrikant
#define gamma 0.87						     //constant 'gamma' in Rabinovich-Fabrikant

class RabinoFabrik
{
  	    double t, x[Nrf], y[Nrf], low, high;
  	    bool flag;
  	    std::string s;
		FILE * pFile;
	public:
